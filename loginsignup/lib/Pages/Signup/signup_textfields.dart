...
class _TextfieldState extends State<Textfield> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        textfield('First Name', 'Enter your first name', false,TextInputType.name),
        textfield('Last Name','Enter your last name',false,TextInputType.name),
        textfield('Email', 'Enter your Email Address', false,TextInputType.emailAddress),
        textfield('Phone', 'Enter your phone number', false,TextInputType.number),
        textfield('Password','Enter Strong Password',true,TextInputType.visiblePassword),
        textfield('Confirm Password','Re-Enter your Password',true,TextInputType.visiblePassword),
      ],
    );
  }
}
